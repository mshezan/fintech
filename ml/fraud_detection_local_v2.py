...
Version 2: Fixed visualization issues (no plt.show() blocking)
"""
...
print("="*80)
print("FRAUD DETECTION - LOCAL VERSION (Fixed)")
...
def load_transaction_data(csv_file='transactions_dataset.csv'):
    ...
    try:
        ...
        print("\nTrying synthetic_transactions.csv instead...")
        try:
            df = pd.read_csv('synthetic_transactions.csv')
            print(f"✓ Loaded synthetic data: {len(df)} transactions")
        except FileNotFoundError:
            print(f"❌ No data files found!")
            print("Run: python export_transactions.py")
            return None
...
def train_models(X_train, X_test, y_train, y_test):
    ...
    y_proba_iso = (y_proba_iso - y_proba_iso.min()) / (y_proba_iso.max() - y_proba_iso.min() + 1e-10)
...
# ============================================================================
# STEP 5: VISUALIZE (FIXED - NO BLOCKING)
# ============================================================================

def plot_confusion_matrices(results, y_test):
    """
    Show confusion matrices - FIXED VERSION (no plt.show())
    """
...
def plot_feature_importance(rf_model, feature_names):
    """
    Show which features matter most - FIXED VERSION (no plt.show())
    """
...
def plot_roc_curves(results, y_test):
    """
    Plot ROC curves for all models - FIXED VERSION (no plt.show())
    """
...
def plot_metrics_comparison(comparison_df):
    """
    Bar chart comparing metrics - FIXED VERSION (no plt.show())
    """
...
if __name__ == '__main__':
    ...
    # Step 6: Visualize (FIXED - no blocking)
    ...
    print("\n" + "="*80)
    print("✅ COMPLETE! All files saved successfully")
    print("="*80)
    
    # Print summary
    print("\nGENERATED FILES:")
    print("1. model_comparison.csv ......... Metrics table for paper")
    print("2. confusion_matrices.png ....... Figure 1 - Model accuracy")
    print("3. feature_importance.png ....... Figure 2 - Feature importance")
    print("4. roc_curves.png ............... Figure 3 - ROC curves")
    print("5. metrics_comparison.png ....... Figure 4 - Metrics bar chart")
    
    print("\nNEXT STEPS:")
    print("1. Open confusion_matrices.png to see model performance")
    print("2. Open model_comparison.csv to see numerical results")
    print("3. Use these files in your research paper!")
